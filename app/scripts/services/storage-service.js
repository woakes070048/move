  ...
  .factory('storageService', function ($q, $window, utility, collections, pouchStorageService) {
    ...
    var setData = function (table, data) {
      if (!data.hasOwnProperty('uuid')) {
        throw new Error('data should have a uuid or primary key field.')
      }
    ...
    var insertData = function (table, data) {
      if (data.hasOwnProperty('uuid')) {
        throw new Error('insert should only be called with fresh record that has not uuid or primary key field.')
      }
    ...
    var updateData = function (table, data, updateDateModified) {
      if (!data.hasOwnProperty('uuid')) {
        throw new Error('update should only be called with data that has UUID or primary key already.')
      }
